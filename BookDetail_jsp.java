...
fldproduct_url="Review this book on Amazon.com";
  ...
  String OrderAction(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sAction, String sForm, java.sql.Connection conn, java.sql.PreparedStatement stat) throws java.io.IOException {
    ...
    try {
      ...
      switch (iAction) {
        ...
        case iinsertAction :
			...
			stat = conn.preparedStatement(sSQL);				
			
			stat.setInt(1, toSQL(fldUserID, adNumber));
			stat.setInt(2, toSQL(fldquantity, adNumber));
			stat.setInt(3, toSQL(flditem_id, adNumber));
